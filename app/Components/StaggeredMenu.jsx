            ...
            >
                ...
                >
                    {(() => {
                        ...
                        return arr.map((c, i) => (
                            <div
                                key={i}
                                className="sm-prelayer absolute shadow-2xl top-0 right-0 h-full w-full translate-x-0"
                                style={{ background: c }}
                            />
                        ));
                    })()}
                ...
                >
                    <div className="sm-logo flex items-center select-none pointer-events-auto" aria-label="Logo">
                        <h1 className='text-[#252525] text-[3vw] md:text-[1.6vw] font-[PPNeueMontreal] font-bold'>Nothing2Real</h1>
                    </div>

                    <button
                        ref={toggleBtnRef}
                        className="sm-toggle relative inline-flex items-center text-[3vw] md:text-[1.6vw] gap-[0.3rem] bg-transparent border-0 cursor-pointer text-[#252525] font-medium leading-none overflow-visible pointer-events-auto"
                    ...
                    >
                        <span
                            ref={textWrapRef}
                            className="sm-toggle-textWrap relative inline-block  text-[#252525] h-[1em] overflow-hidden whitespace-nowrap w-[var(--sm-toggle-width,auto)] min-w-[var(--sm-toggle-width,auto)]"
                            aria-hidden="true"
                        >
                        ...
                        >
                            <span
                                ref={plusHRef}
                                className="sm-icon-line absolute left-1/2 bg-current top-1/2 w-full h-[2px]  rounded-[2px] -translate-x-1/2 -translate-y-1/2 [will-change:transform]"
                            />
                            <span
                                ref={plusVRef}
                                    ...
                                    <li className="sm-panel-itemWrap relative overflow-hidden leading-none" key={it.label + idx}>
                                        <a
                                            ...
                                            onClick={(e) => {
                                                ...
                                                // 1. Trigger the close logic (which unfreezes scroll)
                                                closeMenu();

                                                // 2. Trigger the fancy view transition
                                                router.push(it.link, {
